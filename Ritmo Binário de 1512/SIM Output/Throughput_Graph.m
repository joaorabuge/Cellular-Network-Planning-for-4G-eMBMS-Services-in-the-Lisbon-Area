figure1 = figure('name','Throughput Graphic 80ms 1512.0Kbps Avg','NumberTitle','off','PaperPosition',[0.6345 6.345 20.3 15.23],'PaperSize',[20.98 29.68],'Color',[1 1 1]);
hFig = figure(1);
...
figure2 = figure('name','Throughput Graphic 80ms 1512.0Kbps All','NumberTitle','off','PaperPosition',[0.6345 6.345 20.3 15.23],'PaperSize',[20.98 29.68],'Color',[1 1 1]);
hFig2 = figure(2)
